...
public static class Glossary
{
    ...
    public static readonly Dictionary<AncorniaSkillType, string> AncorniaSkillNames = new()
    {
        ...
        [AncorniaSkillType.Shamanism] = "Шаманизм",
        ...
        [AncorniaSkillType.Polemic] = "Полемика",
        ...
        [AncorniaSkillType.Erudition] = "Эрудиция",
        ...
        [AncorniaSkillType.Jewelry] = "Драгоценности",
    ...
    public static readonly Dictionary<AncorniaSkillType, AttributeType> AncorniaSkillCoreAttributes = new()
    {
        ...
        [AncorniaSkillType.Polemic] = AttributeType.Int,
        ...
        [AncorniaSkillType.Erudition] = AttributeType.Int,
        ...
        [AncorniaSkillType.Jewelry] = AttributeType.Int,
